...
[^4]: <i>Mỗi ngày</i> thêm vào theo văn mạch. ds : <i>Phía Đông có sáu thầy Lê-vi</i>. Trong HR <i>mỗi ngày</i> viết (<span class="hebrew-translit">layyôm</span>) gần giống như <i>Lê-vi</i> (<span class="hebrew-translit">lüwiyyîm</span>). Vì thế có lẽ người ghi đà vô ý bỏ chữ trước, hoặc viết chữ sau thay vào.
[^5]: Ở đầu và cuối c.18 này, HR dùng một từ có lẽ gốc ngoại ngữ, không rõ nghĩa là gì. Bản Việt Ngữ dịch thành hai từ : <i>Khu Phụ Thuộc</i> và <i>trong nhà</i>.
...
[^8]: ds : <i>việc bên ngoài</i> (x. Nkm 11,16), nghĩa là không thuộc về phụng tự (x. 2 Sb 19,4-11), được vua uỷ thác, như nói ở cc. 30.32.
[^1*]: 1 Sb 9,17-27
