...
[^1]: Đây là một trong những <i>Thánh vịnh tín nhiệm</i>. Bố cục : <b>1</b>) Tác giả Tv xin Thiên Chúa nghe lời cầu khẩn (c.2) ; <b>2</b>) Tác giả nói với những kẻ chống lại mình hoặc những kẻ thờ ngẫu tượng (cc. 3-6) ; <b>3</b>) Tác giả xin Thiên Chúa ban cho bản thân phúc lành và một cuộc sống yên hàn (cc. 7-9).
[^2]: Có thể có hai cách dịch : <b>1</b>) Theo HR : <i>vinh quang của tôi còn bị phỉ báng</i> ; <b>2</b>) Theo HL : <i>lòng vẫn còn nặng nề, lòng vẫn còn chai đá</i>.
[^3]: Có lẽ, <i>chuyện hư không, điều giả dối</i>, chỉ các ngẫu tượng (x. Am 2,4).
